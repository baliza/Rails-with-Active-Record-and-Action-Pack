...
class Assignment
  ...
  def create_user(params)
    ...
    n.password_digest = params[:password_digest]
    n.save
    return n
  end
  ...
  def create_todolist(params)
      ...
      # return an instance of the class with primary key (`id`), and dates (`created_at` and `updated_at`) assigned
    n = TodoList.new
    n.list_name = params[:name]    
    n.list_due_date = params[:due_date]
    n.save
    return n
  ...
  def find_allusers(offset, limit)
      ...
      return User.all.offset(offset).limit(limit)
  end
  ...
  def find_alllists(offset, limit)
      ...
      return TodoList.all.offset(offset).limit(limit).order("updated_at DESC")
