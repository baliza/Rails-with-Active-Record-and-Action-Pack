...
#    @todo_list.save()
    respond_to do |format|
      if @todo_list.save
        #format.html { redirect_to todo_lists_path, notice: 'Todo item was successfully created.' }        
        format.html { redirect_to @todo_list, notice: 'Todo item was successfully created.' }
        format.json { render :show, status: :created, location: @todo_lists }
      else
